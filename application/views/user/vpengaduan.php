                    ...
                    <div class="body">
                        <div id="form-hidden">
                            <form id="basic-form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php if (isset($action)) echo $action ?>" novalidate>
                                <input type="hidden" name="kecamatan" value="<?= $data->ka_upt ?>">
                                <input type="hidden" name="namapelapor" value="<?= $data->nama ?>">
                                ...
                                <tbody>
                                    ...
                                    if (isset($hasil)) foreach ($hasil as $val) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='<?php echo base_url('pengaduan') . '?func=updatepengaduan&id=' . $val->id_pengaduan ?>' type="button" class="btn btn-success mb-2" title="Edit"><span class="sr-only">Edit</span>
                                                    <i class="fa fa-pencil"></i></a>
                                                <a href="<?php echo base_url('pengaduan/delete') . '?func=pengaduan&id=' . $val->id_pengaduan ?>" onclick="return confirm('Yakin hapus data ini ?')" type="button" class="btn btn-danger mb-2" title="Delete">
